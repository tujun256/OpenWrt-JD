...
cp -rf ${GITHUB_WORKSPACE}/mt7986a-glinet-gl-mt6000-23.04.dts ${GITHUB_WORKSPACE}/openwrt/target/linux/mediatek/files-5.4/arch/arm64/boot/dts/mediatek/mt7986a-glinet-gl-mt6000.dts
